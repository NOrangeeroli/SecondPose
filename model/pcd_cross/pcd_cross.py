...
if __name__ == '__main__':
    ref_points = torch.rand(6, 16, 3)
    src_points = torch.rand(6, 16, 3)
    ref_feats = torch.rand(6, 16, 256)
    src_feats = torch.rand(6, 16, 256)
    model = GeometricTransformer(input_dim=256,
                                 output_dim=256,
                                 hidden_dim=256,
                                 num_heads=2,
                                 ...
                                 sigma_a=15,
                                 angle_k=3,)
    red_feats_new, src_feats_new = model(ref_points, src_points, ref_feats, src_feats)
    sdf = 1